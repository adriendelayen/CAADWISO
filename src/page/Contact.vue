    ...
    <div class="myBlocks">
      ...
      <form ref="myForm" @submit.prevent="handleSubmit()">
        ...
        <div>
          ...
          <input class="field" id="lastname" v-model.trim="forml.lastname" @input="lastname_dirty = true"/>
          <small class="error" v-show="lastnameError">{{error}}</small>
        </div>
        <div>
          <label for="firstname"><small id="red">* </small>Prénom</label>
          <input class="field" id="firstname" v-model.trim="forml.firstname" @input="firstname_dirty = true"/>
        ...
        <div>
          ...
          <small class="error" v-show="questionError">{{error}}</small>
        </div>
        <div>
